declare const styles: {
  ...
  readonly "active:bg-bg-brand-pressed": string;
  ...
  readonly "bg-bg-selected-secondary": string;
  readonly "bg-bg-selected-strong": string;
  readonly "bg-bg-selected-tertiary": string;
  ...
  readonly "border-border-brand": string;
  ...
  readonly "dark:bg-bg": string;
  readonly "dark:bg-bg-inverse": string;
  readonly "dark:bg-bg-selected-strong": string;
  readonly "dark:bg-bg-selected-tertiary": string;
  readonly "dark:bg-white": string;
  readonly "dark:bg-white/40": string;
  ...
  readonly "hover:bg-bg-brand-hover": string;
  readonly "hover:bg-bg-hover": string;
  readonly "hover:bg-opacity-40": string;
  readonly "hover:bg-opacity-80": string;
  ...
  readonly "last-of-type:border": string;
  readonly "last-of-type:border-y": string;
  readonly "last-of-type:mb-2": string;
  readonly "last-of-type:pb-4": string;
